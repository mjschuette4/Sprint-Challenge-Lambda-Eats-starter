...
It allows you to easily get match data from a route

2. How would you explain form validation to someone who has never programmed before?

Basically Validation makes sure that when you fill out a form that it is has valid inputs from the user

3. In 1-2 sentences, define end to end testing. 

It is a way of automatically testing some actions that a user might perform and verifying that they work.
